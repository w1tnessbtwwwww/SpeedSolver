...
Revision ID: 57f6e62620c6
Revises: 
Create Date: 2025-04-22 13:10:06.841645
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['parent_objectiveId'], ['objectives.id'], ondelete='CASCADE'),
    ...
    sa.Column('userId', sa.UUID(), nullable=False),
    sa.Column('teamId', sa.UUID(), nullable=False),
    sa.Column('invited_by_request_id', sa.UUID(), nullable=True),
    sa.ForeignKeyConstraint(['invited_by_request_id'], ['team_invitations.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['teamId'], ['teams.id'], ),
    sa.ForeignKeyConstraint(['userId'], ['users.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
